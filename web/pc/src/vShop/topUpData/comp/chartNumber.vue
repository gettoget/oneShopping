<template>
  <Card class="box_col chartNumberBox">
    ...
    <div id="chartNumber" style="height: 50%">

    </div>
    <hr style="width: 100%" align="right">
    <div id="chartNumberFail" style="height: 50%">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDataFail() {
                this.$http.post('/api/statis/rechargeNumFail').then(res => {
                    if (res.code == 200) {
                        let a = [
                            {
                                value: res.result.one,
            ...
            buildEchartFail(a, b) {
                var v = this
                var myChart = echarts.init(document.getElementById('chartNumberFail'));
